...
namespace grobner {
    ...
    public:
      ...
      Polynomial<T, TNumberOfVariables> reduce(const PolynomialVector<T, TNumberOfVariables>& PolySet, const Polynomial<T, TNumberOfVariables>& Poly) {
        ...
        const Monomial<T, TNumberOfVariables>& get_monomial(
                const Polynomial<T, TNumberOfVariables>& pol,
                size_t index) const {
        ...
        Polynomial<T, TNumberOfVariables> sort_pol(Polynomial<T, TNumberOfVariables>& pol) const {
